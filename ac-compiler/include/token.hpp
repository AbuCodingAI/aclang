...
enum class TokenType {
    ...
    KW_BAND,        // band (bitwise AND)
    KW_BXOR,        // bxor (bitwise XOR)
    KW_BNOT,        // bnot (bitwise NOT, alias of ~)
    KW_QUICKTHREAD, // quickthread f(args) — run call on a lightweight thread (Go: goroutine)
