...
class CppCodeGen {
    ...
    void genNode(const ASTNode& node) {
        ...
        case NodeType::IfStmt: {
            if (node.value == "OTHER") {
                // strip the trailing "}\n" from the previous if/elseif block
