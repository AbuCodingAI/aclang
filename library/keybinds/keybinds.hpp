...
#ifndef AC_KEYBINDS_HPP
#define AC_KEYBINDS_HPP

#include <string>

namespace ACKeybinds {
    ...
    constexpr const char* KEY_COMMA = ",";
    constexpr const char* KEY_PERIOD = ".";
    constexpr const char* KEY_SLASH = "/";
