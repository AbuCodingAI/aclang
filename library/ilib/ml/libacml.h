...
/* ============================================================================
   AC-NATIVE API (Rosetta Stone)
   ============================================================================ */

tensor_id_t ml_tensor(double value);
tensor_id_t ml_grid(int64_t rows, int64_t cols, double fill);
int         ml_gradient_track(tensor_id_t tensor_id, int enabled);
int         ml_grad_wipe(tensor_id_t tensor_id);
int         ml_weights(double learning_rate, tensor_id_t tensor_id);
double      ml_take(tensor_id_t tensor_id);
tensor_id_t ml_add(tensor_id_t a, tensor_id_t b);
tensor_id_t ml_multiply(tensor_id_t a, tensor_id_t b);
tensor_id_t ml_relu(tensor_id_t x);
