# Vendored snapshot from AC/abudb-sql/abudb.py for the AC `web-server` ilib. NOT
# auto-synced with the original — re-copy by hand if abudb-sql gets fixes this needs.
