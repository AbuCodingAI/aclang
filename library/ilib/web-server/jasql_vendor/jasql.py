# Vendored snapshot from AC/abudb-sql/jasql.py for the AC `web-server` ilib's SQL
# support (server.db_run/db_import/db_reset). NOT auto-synced with the original —
# re-copy by hand if abudb-sql gets fixes this ilib needs.
import re
import fnmatch
