...
.section .data
    ...
    func_page_get: .asciz "ac_web_page_get"
...
; web.page_get(url) -> const char*
web_page_get:
    push %rdi                   ; save url pointer
    call load_web_library
    test %rax, %rax
    jz .web_page_get_fail

    mov %rax, %rdi             ; lib_handle
    lea func_page_get(%rip), %rsi
    call dlsym@plt

    pop %rdi                    ; restore url pointer
    jmp *%rax                   ; tail-call ac_web_page_get(url)
