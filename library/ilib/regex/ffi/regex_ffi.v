...
fn ac_regex_clist(arr &&char, n int) []string {
...
struct AcRegexNS {}
fn (o AcRegexNS) match(s string, p string) bool          { return regex_match(s, p)         }
fn (o AcRegexNS) test(s string, p string) bool            { return regex_test(s, p)          }
fn (o AcRegexNS) search(s string, p string) string        { return regex_search(s, p)        }
fn (o AcRegexNS) replace(s string, p string, r string) string     { return regex_replace(s, p, r)     }
fn (o AcRegexNS) replace_all(s string, p string, r string) string { return regex_replace_all(s, p, r) }
fn (o AcRegexNS) count(s string, p string) int            { return regex_count(s, p)         }
fn (o AcRegexNS) escape(s string) string                  { return regex_escape(s)           }
fn (o AcRegexNS) find_all(s string, p string) []string    { return regex_find_all(s, p)      }
fn (o AcRegexNS) split(s string, p string) []string       { return regex_split(s, p)         }
fn (o AcRegexNS) groups(s string, p string) []string      { return regex_groups(s, p)        }

const regex = AcRegexNS{}
